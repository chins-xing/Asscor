...
> ⚠️ **已废弃（2026-08-14）**：本文件是微内核剥离重构之前的旧版 v0.3.0 规划（架构加固）。
> 其全部 12 项任务已于 2026-07-12 完成并并入 v0.2.3（见 `docs/audits/VERSION_AUDIT_v0.3.0.md`）。
> 当前 v0.3.0 方向为**主动防御研究**（见 `lunwen/research-core/主动防御设计白皮书.md`，可选方向，未追踪）。
> 本文件仅作历史参考。

**目标版本**: v0.3.0 | **起始版本**: v0.2.3 | **预估工期**: 4-6 周
