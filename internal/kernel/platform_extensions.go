...
// Modules fire events via Extensions().Execute() but do NOT own point definitions.
// This single source of truth centralizes the extension architecture at the platform layer.
func RegisterAllExtensionPoints(kc KernelContext) {
	// ── Detect 阶段 ──
