...
const twoFactorChainJSONL = `{"scenario_id":"CONS-R1","factors":["A","B"],"observed":{"domain_scores":{"attack_surface":80},"threshold":50,"spc_score":0.8,"threat_coeff":0.7,"edge_factor_chain":[{"factor":"A","trigger_check":"OT-005","c_trigger":1.0,"effective_factor":0.6,"ts":"2026-09-08T10:00:00Z"},{"factor":"B","trigger_check":"OT-005","c_trigger":1.0,"effective_factor":0.5,"ts":"2026-09-08T10:00:01Z"}]},"ground_truth":{"compromised":true,"time_to_compromise_s":100,"ttps_achieved":2,"nodes_affected":1,"block_effective":false,"basis":"targeted_ttp"}}
{"scenario_id":"CONS-R2","factors":["A"],"observed":{"domain_scores":{"attack_surface":30},"threshold":50,"spc_score":0.8,"threat_coeff":0.7,"edge_factor_chain":[{"factor":"A","trigger_check":"OT-005","c_trigger":1.0,"effective_factor":0.9,"ts":"2026-09-08T10:00:02Z"}]},"ground_truth":{"compromised":false,"time_to_compromise_s":0,"ttps_achieved":0,"nodes_affected":0,"block_effective":true,"basis":"targeted_ttp"}}
`
