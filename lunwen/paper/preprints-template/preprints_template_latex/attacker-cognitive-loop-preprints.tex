...
of the Caldera profile; (ii) \textbf{prediction sharpness trajectory} ---
...
rounds (E1--E9). E6 confirms the defensive fallback: an unmapped technique
...
evidence that the loop scales with topology size.
